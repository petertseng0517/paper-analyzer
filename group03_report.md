...
![主介面全覽：左側分析書架、右側分析結果區](img/主介面全覽.png)
...
![單篇分析完成畫面：論文摘要、優點 Pros、缺點 Cons 三區塊](img/分析結果頁面1.png)
...
![分析進行中：進度條顯示 26%，目前正在分析第 3/35 段](img/上傳與分析進度畫面.png)
...
![跨論文比較進行中（95%）：系統正在比對兩篇論文的重點與異同](img/跨論文分析比較過程.png)

比較完成後，系統輸出摘要比較、優缺點比較表與總結推薦：

![比較結果：摘要比較、優缺點表、及總結推薦](img/跨論文多篇比較結果.png)
