...
本專案以「讓人文研究者更輕鬆地進行初步文獻篩選」為出發點，在保護學術資料隱私的前提下，實現了自動化的論文摘要生成與多篇比較功能。
...
| 組員 | 負責工作 |
|------|---------|
| 莊千響 | 尋找並評估適合的本地端模型；實作英文論文摘要與優缺點生成；實作多篇論文輸入與整合比較功能 |
| 葉耀斌 | 開放支援中文論文輸入；實作拖曳上傳功能；加入載入旋轉動畫與進度條狀態動畫 |
